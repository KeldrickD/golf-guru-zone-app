    ...
    <>
      ...
      {isMenuOpen && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -10 }}
          transition={{ duration: 0.2 }}
          className="md:hidden fixed top-16 left-0 right-0 z-40 bg-white dark:bg-gray-900 border-b shadow-lg"
        >
          <div className="px-4 py-4 space-y-3 max-h-[80vh] overflow-y-auto">
            {navigationItems.map((item) => {
              ...
              return (
                ...
                >
                  <div className={`p-2 rounded-md ${isActive ? 'bg-primary/20' : 'bg-gray-100 dark:bg-gray-800/40'}`}>
            ...
            <Link 
              href="/pricing" 
              className="flex items-center space-x-3 px-3 py-3 rounded-lg text-base font-medium hover:bg-gray-100 text-gray-700 dark:text-gray-200 dark:hover:bg-gray-800/40"
              onClick={() => setIsMenuOpen(false)}
            >
              <div className="p-2 rounded-md bg-gray-100 dark:bg-gray-800/40">
                <Trophy className="h-5 w-5" />
              </div>
              <div className="flex flex-col">
                <span>Pricing</span>
                <span className="text-xs text-gray-500 dark:text-gray-400">View our subscription plans</span>
              </div>
            </Link>

            {/* Mobile User Account */}
            <div className="px-3 py-3 border-t mt-3">
              {!session ? (
                <Button onClick={() => signIn('google')} className="w-full rounded-lg">
                  Sign In with Google
                </Button>
              ) : (
                <div className="space-y-3">
                  <div className="flex items-center space-x-3 p-2 rounded-lg bg-gray-50 dark:bg-gray-800/40">
                    {session.user?.image ? (
          ...
          >
            <div className="p-4 flex items-center border-b">
              ...
              <input 
                ...
                className="flex-1 bg-transparent border-none outline-none text-lg text-gray-700 dark:text-gray-200" 
                autoFocus
              />
              <Button 
                variant="ghost" 
            ...
            <div className="p-4">
              ...
              <div className="mt-2 space-y-2">
                <div className="p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer">
