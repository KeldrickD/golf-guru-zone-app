...
// Main component
const BetFormVisual: React.FC<BetFormVisualProps> = ({ onBetCreated }) => {
  // Step tracking
        ...
        {success && (
          <SuccessContainer>
            ...
            <Button
              variant="default"
              type="submit"
              className={currentStep === totalSteps ? 'w-full bg-blue-600 hover:bg-blue-700' : ''}
            >
