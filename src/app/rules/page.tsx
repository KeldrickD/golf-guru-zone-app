...
import { BookOpen, Send, Search, MessageSquare, Info, HelpCircle, Bookmark, RotateCw } from 'lucide-react';
  ...
  return (
    <>
      <PageHeader
        ...
        description="Get expert answers to all your golf rules questions from our AI-powered assistant."
        icon={BookOpen}
        gradient
      />
